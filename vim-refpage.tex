...
\newenvironment{cmdtable}[2][]
	...
	{\ifthenelse{\equal{#1}{}}{}{\titlebar{#1}\par}
	 ...
	 \tabulinesep=4pt%
	 \taburulecolor{white}%
	 \setlength{\cmdtabwidth}{\linewidth+\tabcolsep}
	 \begin{tabu} to 
		 \cmdtabwidth{@{}*#2{|%
		 >{\begin{adjustbox}{raise=0pt}\setsize8\cmdstyle}c<{\end{adjustbox}}%
		 @{\hspace{2\tabcolsep}\hspace{-1pt}}
		 >{\setsize4\setstretch{0.75}}X[1,m,l]|}@{}}
	 }
	 {\end{tabu}\rowcolors{1}{white}{white}}
