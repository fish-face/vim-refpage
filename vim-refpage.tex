...
\begin{table}[Searching]{|c|c|X[1,m,L]|c|c|}\hline
	\rowcolor{gray!50}{\titlestyle Forward} &
	{\titlestyle Backward} &
	...
	\multirow{2}{*}{\cmdstyle n} & \multirow{2}{*}{\cmdstyle 
	N}\\\cline{1-3}
	\cellcolor{gray!50}{\cmdstyle *} & 
	\cellcolor{gray!50}{\cmdstyle \#} & 
	\cellcolor{gray!50}{word under cursor}
	& &\\\hline
	\cmdstyle t{\egcmdstyle x} &
	\cmdstyle T{\egcmdstyle x} &
	upto {\egcmdstyle x} & 
	\multirow{2}{*}{\cmdstyle ;} & \multirow{2}{*}{\cmdstyle ,}\\\cline{1-3}
	\cellcolor{gray!50}{\cmdstyle f{\egcmdstyle x}} &
	\cellcolor{gray!50}{\cmdstyle F{\egcmdstyle x}} &
	\cellcolor{gray!50}{find {\egcmdstyle x}} &&\\\hline
\end{table}
...
\begin{cmdtable}{4}
	o & \taghelp{\parbox{\linewidth}{switch cursor to start/end}}{v\_o} &
	gv & \taghelp{\parbox{\linewidth}{reselect previous area}}{gv} &
	I & \taghelp{\parbox{\linewidth}{prepend to each visual block 
	line}}{v\_b\_I} &
